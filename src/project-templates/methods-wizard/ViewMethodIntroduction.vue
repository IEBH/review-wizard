<template>
	<div>
		<h1>Introduction</h1>
		<InputEditorMultiline question="What is the Introduction?" :placeholder="placeholder" :value="introduction.intro"
